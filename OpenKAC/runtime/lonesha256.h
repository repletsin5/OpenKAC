...
//macros
#define S(x, n) (((((UINT32)(x)&0xFFFFFFFFUL)>>(UINT32)((n)&31))|((UINT32)(x)<<(UINT32)((32-((n)&31))&31)))&0xFFFFFFFFUL)
...
#define LOAD32H(x, y) \
    x = ((UINT32)((y)[0]&255)<<24)|((UINT32)((y)[1]&255)<<16)|((UINT32)((y)[2]&255)<<8)|((UINT32)((y)[3]&255));
#define STORE64H(x, y) \
...
LSHA256DEF int lonesha256(unsigned char out[32], const unsigned char* in, size_t len) {
    ...
    UINT64 sha256_length = 0;
    UINT32 sha256_state[8] = {
