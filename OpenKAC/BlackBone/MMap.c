    ...
    )
{
    ...
    static UINT32 maxSafeStrSize = 0x400;
SkipSxS:
    BBSafeAllocateString( &fullResolved, maxSafeStrSize);
    ...
    if(fullResolved.Buffer)
        RtlZeroMemory( fullResolved.Buffer, maxSafeStrSize);
